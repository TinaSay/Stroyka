...
$config = [
    ...
    'on afterRequest' => function () {
        ...
        Yii::$app->getResponse()->getHeaders()->add('Content-Security-Policy',
            'default-src \'none\'; script-src \'self\' \'unsafe-inline\' \'unsafe-eval\'; connect-src \'self\' speller.yandex.net; child-src gisp.gov.ru self; frame-src gisp.gov.ru self;  img-src * data: blob:; style-src * \'unsafe-inline\'; font-src * data:;');
    },
    'container' => [
        'definitions' => [
    ...
    'modules' => [
        ...
        'menu' => [
            ...
            'useSection' => true, // if menu is separated by type, like a top/left menu, enable this
